...
func TestBuyAsset(t *testing.T) {
	...
	investor.AddAsset(investorAssetPosition)
	...
	assert.Equal(5, investor2.GetAsset("asset1").Shares, "Investor 2 should have 5 shares of asset 1")
}
...
func TestBuyAssetWithDifferentAssents(t *testing.T) {
	...
	investor2.AddAsset(investorAssetPosition2)
...
func TestBuyPartialAsset(t *testing.T) {
	...
	investor3.AddAsset(investorAssetPosition2)
	...
	assert.Equal(3, investor2.GetAsset("asset1").Shares, "Investor 2 should have 3 shares of asset 1")
